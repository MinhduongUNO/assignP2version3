...
class Investment(models.Model):
    ...
    result_value = models.DecimalField(max_digits=10, decimal_places=2, null=True)
    ...
    def results_by_investment(self):
        self.result_value = self.recent_value - self.acquired_value
...
class Stock(models.Model):
    ...
    stock_value = models.DecimalField(max_digits=10, decimal_places=2, null=True)
